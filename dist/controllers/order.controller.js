...
import { createOrderService, deleteOrderService, getOrdersByUser, getOrdersByUsers, updateAllOrderItemsStatus, updateOrderItemStatus, } from "../services/orderservices.js";
...
export const getMyOrders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (userRole === "admin") {
            ...
            result = yield getOrdersByUsers(userId, limit, offset);
        }
        return res.json({
            data: result.data,
            pagination: {
...
export const updateOrderStatusController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        try {
            const result = yield updateAllOrderItemsStatus(userId, orderId, status);
...
export const updateOrderItemStatusController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updatedItem = yield updateOrderItemStatus(userId, itemId, status);
...
export const deleteOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const deleteOrder = yield deleteOrderService(id);
        if (!deleteOrder) {
