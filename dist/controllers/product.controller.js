...
import { productCreationSchema, productupdateSchema, } from "../validators/product.validation.js";
import { createProductService, deleteProductService, getAllProductsService, getProductByIdService, updateProductService, } from "../services/productservices.js";
// CREATE PRODUCT
...
export const getAllProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const query = isAdmin
            ? baseQuery
            : Object.assign(Object.assign({}, baseQuery), { minInventory: 1 });
        const productsWithCount = yield getAllProductsService(query);
...
export const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(req.params.id);
    try {
        const deleteProduct = yield deleteProductService(id);
        if (!deleteProduct) {
